...
<body>
	<div id="wrap">
		...
		<div id=header">
			<d"iv class="logo" style="text-align:center;">
		...
		<div class="login_menu">
				...
				<button class="signup_btn" style="float: right;" onclick=" ">Sign Up</button>&nbsp;&nbsp;
				<button class="login_btn" style="float: right;" onclick=" ">Login</button><br><br>
		</div>
